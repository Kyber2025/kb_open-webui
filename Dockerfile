...
RUN set -e; \
    ...
    pip3 install 'torch<=2.9.1' 'torchvision==0.24.1' torchaudio --index-url https://download.pytorch.org/whl/$USE_CUDA_DOCKER_VER --no-cache-dir; \
    ...
    pip3 install 'torch<=2.9.1' 'torchvision==0.24.1' torchaudio --index-url https://download.pytorch.org/whl/cpu --no-cache-dir; \
    uv pip install --system -r requirements.txt --no-cache-dir; \
